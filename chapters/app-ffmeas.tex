These figures show the rest of the datadriven background estimatation on the rate at which jets fake tau leptons in QCD, ttbar, and W+jet regions. The y-axis can be interpreted as the percent fake rate. 
